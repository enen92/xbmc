...
bool CFileItem::IsVideo() const
{
  ...
  return URIUtils::HasExtension(GetDynPath(), CServiceBroker::GetFileExtensionProvider().GetVideoExtensions());
}
...
bool CFileItem::IsAudio() const
{
  ...
  return URIUtils::HasExtension(GetDynPath(), CServiceBroker::GetFileExtensionProvider().GetMusicExtensions());
}
