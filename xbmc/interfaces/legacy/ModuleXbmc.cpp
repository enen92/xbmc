...
namespace XBMCAddon
{
  ...
  namespace xbmc
  {
    ...
    int getTRAY_OPEN()
    {
      return static_cast<int>(TrayState::TRAY_OPEN);
    }
    int getDRIVE_NOT_READY()
    {
      return static_cast<int>(DriveState::DRIVE_NOT_READY);
    }
    int getTRAY_CLOSED_NO_MEDIA()
    {
      return static_cast<int>(TrayState::TRAY_CLOSED_NO_MEDIA);
    }
    int getTRAY_CLOSED_MEDIA_PRESENT()
    {
      return static_cast<int>(TrayState::TRAY_CLOSED_MEDIA_PRESENT);
    }
