...
enum AVChannel CAEUtil::GetAVChannel(enum AEChannel aechannel)
{
  switch (aechannel)
  {
  case AE_CH_FL:   return AV_CHAN_FRONT_LEFT;
  case AE_CH_FR:   return AV_CHAN_FRONT_RIGHT;
  case AE_CH_FC:   return AV_CHAN_FRONT_CENTER;
  case AE_CH_LFE:  return AV_CHAN_LOW_FREQUENCY;
  case AE_CH_BL:   return AV_CHAN_BACK_LEFT;
  case AE_CH_BR:   return AV_CHAN_BACK_RIGHT;
  case AE_CH_FLOC: return AV_CHAN_FRONT_LEFT_OF_CENTER;
  case AE_CH_FROC: return AV_CHAN_FRONT_RIGHT_OF_CENTER;
  case AE_CH_BC:   return AV_CHAN_BACK_CENTER;
  case AE_CH_SL:   return AV_CHAN_SIDE_LEFT;
  case AE_CH_SR:   return AV_CHAN_SIDE_RIGHT;
  case AE_CH_TC:   return AV_CHAN_TOP_CENTER;
  case AE_CH_TFL:  return AV_CHAN_TOP_FRONT_LEFT;
  case AE_CH_TFC:  return AV_CHAN_TOP_FRONT_CENTER;
  case AE_CH_TFR:  return AV_CHAN_TOP_FRONT_RIGHT;
  case AE_CH_TBL:  return AV_CHAN_TOP_BACK_LEFT;
  case AE_CH_TBC:  return AV_CHAN_TOP_BACK_CENTER;
  case AE_CH_TBR:  return AV_CHAN_TOP_BACK_RIGHT;
  default:
    return AV_CHAN_NONE;
  }
}
