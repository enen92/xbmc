...
void CSlideShowDelegator::RunSlideShow(const std::string &strPath, bool bRecursive,
                    bool bRandom, bool bNotRandom,
                    const std::string &beginSlidePath, bool startSlideShow,
                    SortBy method,
                    SortOrder order,
                    ...
                    const std::string &strExtensions)
{
  if (m_delegate)
  {
    m_delegate->RunSlideShow(strPath, bRecursive, bRandom, bNotRandom, beginSlidePath, startSlideShow, method, order, sortAttributes, strExtensions);
  }
}

void CSlideShowDelegator::AddFromPath(const std::string &strPath, bool bRecursive,
                   SortBy method,
                   SortOrder order,
                   SortAttribute sortAttributes,
                   const std::string &strExtensions)
